    ...
    <li class="item row-type gpa__main_post col-md-4 col-sm-4">
        <?php if (has_post_thumbnail()):?>
          <div class="gpa__post_thumbnail_small_wrapper">
              ...
              <img width='360' height='240' class="gpa__post_thumbnail_small wp-post-image" src="<?php the_post_thumbnail_url('smallest');?>" alt="Post thumbnail" srcset="<?php the_post_thumbnail_url();?>  100w" sizes="(max-width: 360px) 100vw, 360px"></a>
        ...
        <div class="post-c-wrap">
            ...
            <div class="meta">
                <div class="post-date"><?php echo human_time_diff(get_the_time('U'), current_time('timestamp')).' ago'; ?><span class="gpa__news_cat_separator"> || </span><?php the_category('<span class="gpa__news_cat_separator"> || </span> ');?> </div>
            </div>
        </div>
    </li>
    <?php $i++; endwhile; ?>
...
<?php if(have_posts()):?>
  ...
  <?php 
  query_posts('meta_key=post_views_count&orderby=meta_value_num&cat=!30&posts_per_page=7');
