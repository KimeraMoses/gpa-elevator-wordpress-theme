...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" enctype="multipart/form-data" action="">
		...
		<fieldset class="univ">
			<label for="user-submitted-univ"><?php esc_html_e('University Name', 'usp'); ?></label>
			<input id="user-submitted-univ" name="user-submitted-univ" type="text" value="" placeholder="<?php esc_attr_e('University Name', 'usp'); ?>"required class="usp-input">
		</fieldset>
		...
		<fieldset class="usp-tags">
			<label for="user-submitted-tags"><?php esc_html_e('Notice Tags', 'usp'); ?></label>
